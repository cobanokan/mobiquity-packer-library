...
class PackingSolutionTest {
	...
	void shouldReturnNewSolutionWithAddedNewItem() {
		...
		PackingSolution solutionWithNewItem = empty.solutionWithNewItem(firstItem);
		...
		PackingSolution solutionWithSecondItem = solutionWithNewItem.solutionWithNewItem(secondItem);
	...
	void outputWithMultipleItemsShouldBeOrdered() {
		...
		PackingSolution empty = PackingSolution.empty();
		String output = empty.solutionWithNewItem(firstItem)
			.solutionWithNewItem(secondItem)
			.solutionWithNewItem(thirdItem)
			.getOutput();
	...
	void whenCostsAreEqualLighterSolutionShouldBePrefered() {
		...
		PackingSolution solutionWithFirstItem = empty.solutionWithNewItem(firstItem);
		PackingSolution solutionWithSecondItem = empty.solutionWithNewItem(secondItem);
